...
const connectNav = [
  { href: "/dashboard/connect", label: "Overview", icon: Eye, exact: true },
  { href: "/dashboard/connect/website", label: "Website", icon: Globe2, exact: false },
  { href: "/dashboard/connect/application", label: "Application", icon: Smartphone, exact: false },
  { href: "/dashboard/connect/connections", label: "Connections", icon: Cable, exact: false },
  { href: "/dashboard/connect/sync", label: "Sync Status", icon: RefreshCw, exact: false },
  { href: "/dashboard/connect/activity", label: "Activity Log", icon: Activity, exact: false },
];
