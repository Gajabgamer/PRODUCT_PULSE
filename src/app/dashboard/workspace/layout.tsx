...
const workspaceNav = [
  { href: "/dashboard/workspace", label: "Overview", icon: Eye, exact: true },
  { href: "/dashboard/workspace/members", label: "Members", icon: Users, exact: false },
  { href: "/dashboard/workspace/requests", label: "Agent Requests", icon: ShieldCheck, exact: false },
  { href: "/dashboard/workspace/issues", label: "Shared Issues", icon: GitPullRequestArrow, exact: false },
  { href: "/dashboard/workspace/tickets", label: "Tickets", icon: Ticket, exact: false },
  { href: "/dashboard/workspace/activity", label: "Live Activity", icon: Activity, exact: false },
];
