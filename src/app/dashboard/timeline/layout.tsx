...
const timelineNav = [
  { href: "/dashboard/timeline", label: "Timeline", icon: Clock, exact: true },
  { href: "/dashboard/timeline/reports", label: "Weekly Reports", icon: FileBarChart2, exact: false },
];
